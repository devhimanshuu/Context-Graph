 ...
 *
 * Example: `/settings/general` → `[Settings]` for known segments. Unknown
 * segments fall back to a humanized segment name so breadcrumbs never break
 * when a new route is added before its title is registered.
 */
