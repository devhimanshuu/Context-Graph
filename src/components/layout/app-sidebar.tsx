 ...
 * Application sidebar.
 *
 * - Desktop: fixed-width aside, visible from `lg` up.
 * - Mobile: rendered inside a Sheet, toggled from the header hamburger.
 * Both surfaces share `SidebarBody` so navigation never diverges.
 */
